  ...
  const renderPath = () => {
    switch (name) {
      ...
      case 'waves':
        return (
          <>
            <path d="M2 6c3 0 3-2 6-2s3 2 6 2 3-2 6-2" stroke={color} strokeWidth="2" strokeLinecap="round" fill="none" />
            <path d="M2 12c3 0 3-2 6-2s3 2 6 2 3-2 6-2" stroke={color} strokeWidth="2" strokeLinecap="round" fill="none" />
            <path d="M2 18c3 0 3-2 6-2s3 2 6 2 3-2 6-2" stroke={color} strokeWidth="2" strokeLinecap="round" fill="none" />
          </>
        );
      case 'landmark':
        return (
      ...
      case 'tag':
        return (
          <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82zM7 7h.01" stroke={color} strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        );
      case 'sparkles':
        return (
          <path d="M12 3l1.91 5.89L20 10l-5.09 3.11L16 19l-4-3.11L8 19l1.09-5.89L4 10l6.09-1.11L12 3z" stroke={color} strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        );
      default:
        return null;
    }
